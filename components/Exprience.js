...
import stopwatch from '../public/image/stopwatch.png';
 ...
 const Exprience = () => {
    return (
        <div className="px-8 py-16  sm:max-w-xl md:max-w-full md:px-24 lg:px-20 lg:py-20 border" id='projects'>
       ...
       <Link href="https://malikfinancials.com/ads/"> <Image src={trendily}  alt="html-logo" className='h-72'  /></Link>
       </div>
       <div className="relative p-px overflow-hidden h-72 transition cursor-pointer duration-300  transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
       <Link href="https://malikfinancials.com/"> <Image src={malakfinancial}  alt="html-logo" className='h-72'  /></Link>
       ...
       <Link href="https://motherboardtoday.com/"> <Image src={motherboard}  alt="html-logo" className='h-72'  /></Link>
       </div>
     </div>
     <div className="grid gap-8 row-gap-5 lg:grid-cols-3 mt-10 ">
       ...
       <Link href="https://onlineshop-4f466.web.app/"> <Image src={onlineshop}  alt="html-logo" className='h-72'  /></Link>
      
       </div>
       <div className="relative p-px overflow-hidden h-72 transition cursor-pointer duration-300  transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
       <Link href="https://ylxw-3484d.web.app/"> <Image src={olxsimple}  alt="html-logo" className='h-72'  /></Link>
        
       </div>
       <div className="relative p-px overflow-hidden transition cursor-pointer duration-300 transform border rounded shadow-sm hover:scale-105 group hover:shadow-xl">
       <Link href="https://stopwatch-12d9b.web.app/"> <Image src={stopwatch}  alt="html-logo" className='h-72'  /></Link>
       </div>
     </div>
